...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">m4rcosx15@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'm4rcosx15@github:~$ whoami <tspan fill="{INK}">Marcos</tspan></text>')
parts.append(f'<rect x="{PAD+189}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
